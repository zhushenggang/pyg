...
public class SellerServiceImpl implements SellerService {
     ...
     * @param reNewPwd
     */
    public PygResult updatePassword(String id, String oldPwd, String newPwd, String reNewPwd) {
        //获取用户信息
        ...
        boolean flag = passwordEncoder.matches(oldPwd, password);
        if (!flag) {
            ...
            //设置新密码
            tbSeller.setPassword(encodePassWord);
            //更新数据库
            sellerMapper.updateByPrimaryKey(tbSeller);
