...
app.service('seckillOrderService', function ($http) {
    ...
    //秒杀订单下单
    this.saveOrder = function (seckillId) {
        return $http.get("../seckillOrder/saveOrder/" + seckillId);
    }


    this.checkSeckillOrderStatus = function () {
        return $http.get("../seckillOrder/checkSeckillOrderStatus");
    }
});
